...
/// A minimal valid 1x1 RGB PNG used as the fixture screenshot payload.
pub const FIXTURE_PNG: [u8; 69] = [
...
/// A fixture screenshot triple.
pub fn fixture_shots() -> ShotPayloads {
    ShotPayloads {
        full: FIXTURE_PNG.to_vec(),
        window: FIXTURE_PNG.to_vec(),
        element: FIXTURE_PNG.to_vec(),
    }
}
