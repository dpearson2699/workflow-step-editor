...
*reading* `CONTEXT.md` for vocabulary is not this discipline — that's a one-line
habit any phase can do. This reference is for when you're changing the model,
...
An owning repository's existing glossary or ADR convention governs location,
naming, and structure when one exists; this layout is the default for
...
Inside a work bundle, the root performs these writes and records each
canonical-doc obligation per the decision closure transaction in
`interview-and-doc-authority.md`.
